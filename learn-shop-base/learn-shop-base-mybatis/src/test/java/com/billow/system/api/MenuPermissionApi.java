 ...
 */
@Slf4j
@Tag(name = "MenuPermissionApi",description =  "")
@RestController
@RequestMapping("/menuPermissionApi")
public class MenuPermissionApi extends HighLevelApi<MenuPermissionService, MenuPermissionPo, MenuPermissionSearchParam> {
