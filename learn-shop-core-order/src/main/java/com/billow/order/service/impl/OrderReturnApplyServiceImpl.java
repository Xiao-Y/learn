 ...
 */
@Service
public class OrderReturnApplyServiceImpl extends HighLevelV2ServiceImpl<OrderReturnApplyDao, OrderReturnApplyPo,OrderReturnApplySearchParam> implements OrderReturnApplyService {
