...
CREATE TABLE `p_goods_brand`  (
  ...
  `brand_sort` bigint NOT NULL COMMENT '分类排序',
...
CREATE TABLE `p_goods_category`  (
  ...
  `category_sort` bigint NOT NULL COMMENT '分类排序',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `p_goods_safeguard`  (
  ...
  `price` int NOT NULL COMMENT '保障价格',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `p_goods_sku`  (
  ...
  `shop_id` bigint NOT NULL COMMENT '商铺id,为0表示自营',
...
CREATE TABLE `p_goods_sku_safeguard`  (
  ...
  `safeguard_id` bigint NOT NULL COMMENT 'safeguard_id',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `p_goods_sku_spec_value`  (
  `id` bigint NOT NULL COMMENT '主键',
  `sku_id` bigint NOT NULL COMMENT 'sku_id',
  `spec_key_id` bigint NOT NULL COMMENT '规格id(冗余)',
  `spec_value_id` bigint NOT NULL COMMENT '规格值id',
  `sku_spec_sort` bigint NULL DEFAULT NULL COMMENT '规格值排序',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `p_goods_spec_key`  (
  ...
  `key_sort` bigint NOT NULL COMMENT '规格排序',
...
CREATE TABLE `p_goods_spu`  (
  ...
  `low_price` int NOT NULL COMMENT '最低售价',
  `stock` bigint NULL DEFAULT NULL COMMENT '总库存量',
  `category_id` bigint NOT NULL COMMENT '分类id',
  `brand_id` bigint NOT NULL COMMENT '品牌id',
  `spu_sort` bigint NOT NULL COMMENT '商品排序',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `p_goods_spu_spec`  (
  `id` bigint NOT NULL COMMENT '主键',
  `spu_id` bigint NOT NULL COMMENT 'spu_id',
  `spec_key_id` bigint NOT NULL COMMENT 'spec_key_id',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `p_shop_info`  (
  ...
  `shop_sort` bigint NOT NULL COMMENT '店铺排序',
  `valid_ind` bit(1) NULL DEFAULT NULL COMMENT '是否有效',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  `updater_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后更新人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `sk_seckill`  (
  `id` bigint NOT NULL COMMENT '商品库存ID',
  `sku_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'sku编号,唯一',
...
-- ----------------------------
INSERT INTO `sk_seckill` VALUES (1000, 'SK1000', '1000元秒杀iphone6', 0, '2021-01-22 00:00:00', '2021-01-30 01:00:00', NULL, b'1', '2021-01-21 20:06:23', 'admin', '2021-01-21 20:06:23', 'admin');
INSERT INTO `sk_seckill` VALUES (1001, 'SK1001', '800元秒杀ipad', 2291, '2021-01-22 00:00:00', '2021-01-30 01:00:00', NULL, b'1', '2021-01-21 20:06:23', 'admin', '2021-01-21 20:06:23', 'admin');
INSERT INTO `sk_seckill` VALUES (1002, 'SK1002', '6600元秒杀mac book pro', 300, '2021-01-22 00:00:00', '2021-01-30 01:00:00', NULL, b'1', '2021-01-21 20:06:23', 'admin', '2021-01-21 20:06:23', 'admin');
INSERT INTO `sk_seckill` VALUES (1003, 'SK1003', '7000元秒杀iMac', 400, '2021-01-22 00:00:00', '2021-01-30 01:00:00', NULL, b'1', '2021-01-21 20:06:23', 'admin', '2021-01-21 20:06:23', 'admin');
...
CREATE TABLE `sk_success_killed`  (
  ...
  `kill_state` tinyint NOT NULL DEFAULT -1 COMMENT '秒杀状态标识:-0:无效 1:成功 2:已付款 3:已发货',
  `valid_ind` bit(1) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `creator_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
