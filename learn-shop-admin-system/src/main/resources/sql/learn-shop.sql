...
INSERT INTO `sys_data_dictionary` VALUES (159, 'classType', '1', 'SpringBean', 'publicJob', 0, b'1', '2019-12-06 03:35:44', 'admin', '2019-12-06 07:17:22', 'admin');
INSERT INTO `sys_data_dictionary` VALUES (160, 'classType', '2', 'PackageClass', 'publicJob', 1, b'1', '2019-12-06 03:36:15', 'admin', '2019-12-06 07:17:34', 'admin');
INSERT INTO `sys_data_dictionary` VALUES (161, 'classType', '3', 'HTTP', 'publicJob', 2, b'1', '2019-12-06 07:18:02', 'admin', '2019-12-06 07:18:02', 'admin');
INSERT INTO `sys_data_dictionary` VALUES (162, 'classType', '4', 'SendMQ', 'publicJob', 3, b'1', '2019-12-06 07:18:25', 'admin', '2019-12-06 07:18:40', 'admin');
...
-- ----------------------------
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (1, 'autoTask', '2', '2', NULL, 'lyongtao123@126.com', '<p><strong>以下是自动任务运行情况</strong></p>\n<table>\n<thead>\n<tr>\n<th>日志ID</th>\n<th>任务ID</th>\n<th>任务分组</th>\n<th>任务名称</th>\n<th>是否成功</th>\n<th>运行时间</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>#{id}</td>\n<td>#{jobId}</td>\n<td>#{jobGroup}</td>\n<td>#{jobName}</td>\n<td>#{isSuccess}</td>\n<td>#{runTime}</td>\n</tr>\n</tbody>\n</table>\n<pre><div class=\"hljs\"><code class=\"lang-java\">#{info}\n</code></div></pre>\n', '**以下是自动任务运行情况**\n|日志ID|任务ID|任务分组|任务名称|是否成功|运行时间|\n|-|-|-|-|-|-|\n|#{id}|#{jobId}|#{jobGroup}|#{jobName}|#{isSuccess}|#{runTime}|\n\n```java\n#{info}\n```', 'SELECT r.id,r.job_id as jobId,\n(select d.field_display from sys_data_dictionary d where d.system_module = \'adminSystem\' and d.field_type = \'systemModule\' and d.field_value = r.job_group) as jobGroup,\nr.job_name as jobName,\n(CASE r.is_success\n	WHEN TRUE THEN\n		\'success\'\n	ELSE\n		\'error\'\nEND)\n as isSuccess,\nr.run_time as runTime,\nr.info \nFROM sys_schedule_job_log r \nwhere r.id = #{logId}', NULL, NULL, '自动任务-html-sql', b'1', NULL, NULL, '2020-01-12 03:41:35', 'admin', NULL, NULL);
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (2, 'testhtml', '2', '1', NULL, 'lyongtao123@126.com', '<p><img src=\"admin-system/displayImag/markdown/201908220906457923880.jpg\" alt=\"8111d168a53456c63ed4864e9b65f50d.jpg\" /></p>\n<p><img src=\"admin-system/displayImag/markdown/201908220908311726470.jpg\" alt=\"dalog.jpg\" /></p>\n', '![8111d168a53456c63ed4864e9b65f50d.jpg](admin-system/displayImag/markdown/201908220906457923880.jpg)\n\n![dalog.jpg](admin-system/displayImag/markdown/201908220908311726470.jpg)', NULL, NULL, NULL, 'test-html-固定', b'1', NULL, NULL, '2020-01-12 03:42:41', 'admin', NULL, NULL);
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (3, 'messageParam-FreeMarker', '4', '3', NULL, 'lyongtao123@126.com', '', '', NULL, b'0', 'messageParam.ftl', '测试-fm-par', b'1', NULL, NULL, '2020-01-12 04:12:37', 'admin', NULL, 'messageParam.ftl');
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (4, 'messageSQL-FreeMarker', '4', '2', NULL, 'lyongtao123@126.com', '', '', 'SELECT mail_code as mailCode,template_path as templatePath FROM sys_mail_template r where r.mail_code = \'#{mailCode}\'', b'1', 'messageSQL.ftl', '测试messageSQL.ftl', b'1', NULL, NULL, '2020-01-12 04:13:19', 'admin', NULL, 'messageSQL.ftl');
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (5, 'messageParamSQL-FreeMarker', '4', '4', NULL, 'lyongtao123@126.com', '', '', 'SELECT mail_code as mailCode,template_path as templatePath FROM sys_mail_template r where r.mail_code = \'#{mailCode}\'', b'1', 'messageParamSQL.ftl', '测试messageParamSQL.ftl', b'1', NULL, NULL, '2020-01-12 04:14:30', 'admin', NULL, 'messageParamSQL.ftl');
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (6, 'messageParam-Thymeleaf', '5', '3', NULL, '', '', '', NULL, NULL, 'messageParam', '测试', b'1', NULL, NULL, '2019-08-22 21:08:36', 'admin', NULL, NULL);
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (7, 'messageSQL2-FreeMarker', '4', '2', NULL, 'lyongtao123@126.com', '', '', 'SELECT mail_code as mailCode,template_path as templatePath FROM sys_mail_template r', b'0', 'messageSQL2.ftl', '测试messageSQL2.ftl', b'1', NULL, NULL, '2020-01-12 04:15:12', 'admin', NULL, 'messageSQL2.ftl');
INSERT INTO `learn`.`sys_mail_template`(`id`, `mail_code`, `mail_type`, `data_sources`, `subject`, `to_emails`, `mail_temp`, `mail_markdown`, `run_sql`, `single_result`, `template_path`, `descritpion`, `valid_ind`, `create_time`, `creator_code`, `update_time`, `updater_code`, `attachment`, `template_name`) VALUES (8, 'messageParamSQL2-FreeMarker', '4', '4', NULL, 'lyongtao123@126.com', '', '', 'SELECT mail_code as mailCode,template_path as templatePath FROM sys_mail_template r', b'0', 'messageParamSQL2.ftl', '测试messageParamSQL2.ftl', b'1', NULL, NULL, '2020-01-12 04:15:41', 'admin', NULL, 'messageParamSQL2.ftl');
